...
alias dsee="docker container ls -a && echo 'Docker Images:' && docker image ls -a && echo 'Docker Volumes:' && docker volume ls"
...
alias drmg="docker image ls | grep 'git-tester' | xargs docker image rm"
