...
call doskey.exe john=cd \Src\Git\Isit3202014\isit320_john
call doskey.exe tania=cd \Src\Git\Isit3202014\isit320_vendrovska
call doskey.exe waters=cd \Src\Git\Isit3202014\isit320_waters
call doskey.exe wu=cd \Src\Git\Isit3202014\isit320_wu
