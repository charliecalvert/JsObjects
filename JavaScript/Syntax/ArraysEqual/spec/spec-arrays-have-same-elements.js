...
describe("Arrays have same elements", function() {
    ...
    it("expects null arrays to fail", function() {
        var a1 = null;
        var a2 = [1];
        var result = elvenUtils.arraysHaveSameElements(a1, a2, false);
    ...
    it("expects original test 1 to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, 2, [3, 4]], [1, 2, [3, 2]], false);
        expect(result).toBeFalsy();
    });

    it("expects original test 2 to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, "2,3"], [1, 2, 3]);
        expect(result).toBeFalsy();
    });

    it("expects original test 3 to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, 2, [3, 4]], [1, 2, [3, 4]]);
        expect(result).toBeTruthy();
    });

    it("expects original test 4 to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, 2, 1, 2], [1, 2, 1, 2]);
        expect(result).toBeTruthy();
    });

    it("expects nested array with different ordered elements to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, 2, [3, 4]], [1, 2, [4, 3]]);
        expect(result).toBeTruthy();
    });

    it("expects nested array with different ordered sub arrays to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, [3, 4], 2], [1, 2, [4, 3]]);
        expect(result).toBeTruthy();
    });

    it("expects nested array with different ordered arrays and sub arrays to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([2, [3, 4], 1], [1, 2, [4, 3]]);
        expect(result).toBeTruthy();
    });

    it("expects nested array with different ordered arrays and sub arrays to fail", function() {
        var result = elvenUtils.arraysHaveSameElements([2, [3, 4], 4], [1, 2, [4, 3]]);
        expect(result).toBeFalsy();
    });

    it("expects simple array with different order to pass", function() {
        var result = elvenUtils.arraysHaveSameElements([1, 2, 2, 1], [1, 2, 1, 2]);
        expect(result).toBeTruthy();
    });
