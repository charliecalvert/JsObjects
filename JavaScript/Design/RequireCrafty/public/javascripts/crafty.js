            ...
            function(require, module, exports) {
                ...
                Crafty.c('2D', {
                    ...
                    intersect: function(x, y, w, h) {
                        ...
                        return (
                            mbr._x < rect.x + rect.w &&
                            mbr._x + mbr._w > rect.x &&
                            mbr._y < rect.y + rect.h &&
                            mbr._h + mbr._y > rect.y
                        );
                    },
                    ...
                    _attr: function(name, value) {
                        ...
                        if (name === '_rotation') {
                            ...
                            this._globalZ = parseInt(
                                value + Crafty.zeroFill(this[0], 5),
                                10
                            ); //magic number 10^5 is the max num of entities
                ...
                Crafty.c('Gravity', {
                    ...
                    _enterFrame: function() {
                        ...
                        if (hit) {
                            //stop falling if found and player is moving down
                            if (
                                this._falling &&
                ...
                Crafty.polygon.prototype = {
                    ...
                    rotate: function(e) {
                        ...
                        for (; i < l; i++) {
                            ...
                            x =
                                e.o.x +
                                (current[0] - e.o.x) * e.cos +
                                (current[1] - e.o.y) * e.sin;
                            y =
                                e.o.y -
                                (current[0] - e.o.x) * e.sin +
            ...
            function(require, module, exports) {
                ...
                Crafty.c('DOM', {
                    ...
                    draw: function() {
                        ...
                        if (this._mbr) {
                            var origin =
                                this._origin.x + 'px ' + this._origin.y + 'px';
                    ...
                    DOM: {
                        ...
                        window: {
                            ...
                            _setPixelArt: function(enabled) {
                                ...
                                if (enabled) {
                                    style[
                                        Crafty.DOM.camelize('image-rendering')
                                    ] = 'optimizeSpeed'; /* legacy */
                                    style[
                                        Crafty.DOM.camelize('image-rendering')
                        ...
                        inner: function(obj) {
                            var rect = obj.getBoundingClientRect(),
                                ...
                                borderX =
                                    ...
                                    parseInt(
                                        this.getStyle(obj, 'borderLeftWidth') ||
                                            0,
                                        10
                                    ) ||
                                    0,
                                borderY =
                                    ...
                                    parseInt(
                                        this.getStyle(obj, 'borderTopWidth') ||
                                            0,
                                        10
                                    ) ||
                                    0;
            ...
            function(require, module, exports) {
                ...
                Crafty.c('DebugPolygon', {
                    ...
                    drawDebugPolygon: function() {
                        ...
                        for (var p in this.polygon.points) {
                            ctx.lineTo(
                                this.polygon.points[p][0],
                                this.polygon.points[p][1]
                            );
                        }
                        ctx.closePath();
                ...
                Crafty.DebugCanvas = {
                    ...
                    init: function() {
                        ...
                        Crafty.unbind(
                            'RenderScene',
                            Crafty.DebugCanvas.renderScene
                        );
                        Crafty.bind(
                            'RenderScene',
                            Crafty.DebugCanvas.renderScene
                ...
                Crafty.c('Tween', {
                    ...
                    tween: function(props, duration) {
                        ...
                        for (var propname in props) {
                            if (
                                typeof this.tweenGroup[propname] !== 'undefined'
                            )
                ...
                Crafty.c('Canvas', {
                    ...
                    draw: function(ctx, x, y, w, h) {
                        ...
                        if (this._rotation !== 0) {
                            ...
                            context.rotate(
                                (this._rotation % 360) * (Math.PI / 180)
                            );
                        }
        ...
        7: [
            function(require, module, exports) {
                ...
                Crafty.c('Collision', {
                     ...
                     * @see .checkHits
                     */
                    _createCollisionHandler: function(
                        component,
                        collisionData
                    ) {
                        return function() {
                    ...
                    _SAT: function(poly1, poly2) {
                        ...
                        for (; i < l; i++) {
                            ...
                            for (j = 0; j < l; ++j) {
                                dot =
                                    points1[j][0] * normal.x +
                                    points1[j][1] * normal.y;
                            ...
                            for (j = 0; j < k; ++j) {
                                dot =
                                    points2[j][0] * normal.x +
                                    points2[j][1] * normal.y;
                    ...
                    assignColor: (function() {
                        ...
                        function parseColorName(key, c) {
                            if (typeof dictionary[key] === 'undefined') {
                                ...
                                var rgb = window.getComputedStyle(element)
                                    .color;
                                parseRgbString(rgb, c);
                                dictionary[key] = rgbToHex(
                                    c._red,
                                    c._green,
                                    c._blue
                                );
                ...
                Crafty.extend({
                    ...
                    detectBlur: function(e) {
                        var selected =
                            ...
                            e.clientX <
                                Crafty.stage.x + Crafty.viewport.width &&
                            e.clientY > Crafty.stage.y &&
                                e.clientY <
                                    Crafty.stage.y + Crafty.viewport.height;
                    ...
                    mouseDispatch: function(e) {
                        ...
                        if (tar.nodeName != 'CANVAS') {
                            ...
                            ent = Crafty(
                                parseInt(tar.id.replace('ent', ''), 10)
                            );
                ...
                Crafty.c('Draggable', {
                    ...
                    _ondrag: function(e) {
                        ...
                        if (this._dir) {
                            ...
                            this.x =
                                this._oldX + (pos.x - this._origMouseDOMPos.x);
                            this.y =
                                this._oldY + (pos.y - this._origMouseDOMPos.y);
                        }
                    ...
                    _startDrag: function(e) {
                        this._origMouseDOMPos = Crafty.DOM.translate(
                            e.clientX,
                            e.clientY
                        );
                        this._oldX = this._x;
                ...
                Crafty.fn = Crafty.prototype = {
                    ...
                    addComponent: function(id) {
                        ...
                        for (; c < comps.length; c++) {
                            if (this.__c[comps[c]] === true) continue;
                            this.__c[comps[c]] = true;
                            this.extend(components[comps[c]]);
                            //if constructor, call it
                            if (
                                components[comps[c]] &&
                                'init' in components[comps[c]]
                            ) {
                    ...
                    _attr_set: function() {
                        ...
                        if (typeof arguments[0] === 'string') {
                            data = this._set_create_object(
                                arguments[0],
                                arguments[1]
                            );
                            silent = !!arguments[2];
                            recursive =
                                arguments[3] || arguments[0].indexOf('.') > -1;
                        } else {
                            data = arguments[0];
                            silent = !!arguments[1];
                    ...
                    _set_create_object: function(key, value) {
                        ...
                        if (key.indexOf('.') > -1) {
                            ...
                            first = keys.shift();
                            subkey = keys.join('.');
                            data[first] = this._set_create_object(
                                subkey,
                                value
                            );
                        } else {
    ...
    */
                ...
                Crafty.extend({
                        ...
                        return {
                            init: function() {
                                ...
                                if (typeof gameTime === 'undefined')
                                    gameTime =
                                        new Date().getTime() - milliSecPerFrame;
                                var onFrame =
                    ...
                    e: function() {
                        ...
                        if (arguments.length > 0) {
                            entities[id].addComponent.apply(
                                entities[id],
                                arguments
                            );
                        }
                    ...
                    trigger: function(event, data) {
                        ...
                        for (h in hdl) {
                            ...
                            if (entities[h]) context = Crafty(+h);
                            else if (h === 'global') context = Crafty;
                            else continue;
                    ...
                    device: {
                        ...
                        _normalizeDeviceMotion: function(eventData) {
                            ...
                            var data = {
                                ...
                                tiltLR: Math.round(
                                    (acceleration.x / 9.81) * -90
                                ),
                                tiltFB: Math.round(
                                    ((acceleration.y + 9.81) / 9.81) *
                                        90 *
                                        facingUp
                                )
                            };
        ...
        13: [
                ...
                Crafty.extend({
                    ...
                    diamondIso: {
                        ...
                        init: function(tw, th, mw, mh) {
                            ...
                            this._tile.height =
                                parseInt(th, 10) || parseInt(tw, 10) / 2;
                            this._tile.r = this._tile.width / this._tile.height;

                            this._map.width = parseInt(mw, 10);
                            this._map.height =
                                parseInt(mh, 10) || parseInt(mw, 10);

                            this._origin.x =
                                (this._map.height * this._tile.width) / 2;
                            return this;
                        },
                        /**@
                        ...
                        centerAt: function(x, y) {
                            ...
                            Crafty.viewport.x =
                                ...
                                this._tile.width;
                            Crafty.viewport.y =
                                -pos.top + Crafty.viewport.height / 2;
                        },
            ...
            Crafty.viewport.height = h;   */
                            ...
                            for (
                                yl = y + h;
                                y < yl;
                                y += this._tile.height / 2
                            ) {
                                for (
                                    xl = x + w;
                                    x < xl;
                                    x += this._tile.width / 2
                                ) {
                        ...
                        rectManager = {
                            ...
                            createDirty: function(obj) {
                                ...
                                if (obj.staleRect) {
                                    ...
                                    if (
                                        rectManager.overlap(obj.staleRect, rect)
                                    ) {
                                        rectManager.merge(
                                            obj.staleRect,
                                            rect,
                        ...
                        renderDOM: function() {
                            ...
                            if (dirtyViewport) {
                                ...
                                style.transform = style[
                                    Crafty.support.prefix + 'Transform'
                                ] =
                                    'scale(' +
                                    view._scale +
                                    ', ' +
                                    ...
                                    ')';
                                style.left =
                                    Math.round(view._x * view._scale) + 'px';
                                style.top =
                                    Math.round(view._y * view._scale) + 'px';
                                style.zIndex = 10;
                            }
                ...
                (function testSupport() {
                    var support = (Crafty.support = {}),
                        ...
                        match =
                            ...
                            [],
                        mobile = /iPad|iPod|iPhone|Android|webOS|IEMobile/i.exec(
                            ua
                        );
                ...
                Crafty.extend({
                    ...
                    isometric: {
                        ...
                        px2pos: function(left, top) {
                            return {
                                x: -Math.ceil(
                                    -left / this._tile.width - (top & 1) * 0.5
                                ),
                        ...
                        var j = 0,
                            total =
                                ...
                                (data.images
                                    ...
                                    : 0) +
                                (data.sprites
                                    ? Object.keys(data.sprites).length
                                    : 0),
                            current,
                            fileUrl,
                            obj,
                            ...
                            isValidImage = function(f) {
                                return (
                                    Crafty.image_whitelist.indexOf(getExt(f)) !=
                                    -1
                                );
                            },
            ...
            function(require, module, exports) {
                ...
                Crafty.math = {
                    ...
                    amountOf: function(checkValue, minValue, maxValue) {
                        if (minValue < maxValue)
                            ...
                            return (
                                (checkValue - maxValue) / (minValue - maxValue)
                            );
                    },
                    ...
                    randomInt: function(start, end) {
                        return (
                            start +
                            Math.floor((1 + end - start) * Math.random())
                        );
                    },
                ...
                Crafty.math.Vector2D = (function() {
                    ...
                    Vector2D.prototype.getNormal = function(vecRH, result) {
                        result = result || new Vector2D();
                        return result
                            .setValues(vecRH.y - this.y, this.x - vecRH.x)
                            .normalize();
                    }; // getNormal
                ...
                Crafty.c('Particles', {
                    ...
                    particles: function(options) {
                        ...
                        this.bind('EnterFrame', function() {
                            ...
                            //Selective clearing
                            if (
                                typeof Crafty.DrawManager.boundingRect ==
                                'function'
                            ) {
                                bounding = Crafty.DrawManager.boundingRect(
                    ...
                    _Particles: {
                        ...
                        init: function(options) {
                            ...
                            this.emissionRate =
                                this.maxParticles / this.lifeSpan;
                        ...
                        initParticle: function(particle) {
                            particle.position.x =
                                this.position.x +
                                this.positionRandom.x * this.RANDM1TO1();
                            particle.position.y =
                                this.position.y +
                                this.positionRandom.y * this.RANDM1TO1();

                            var newAngle =
                                (this.angle +
                                    this.angleRandom * this.RANDM1TO1()) *
                            ...
                            var vectorSpeed =
                                this.speed +
                                this.speedRandom * this.RANDM1TO1();
                            particle.direction = this.vectorHelpers.multiply(
                                vector,
                                vectorSpeed
                            );

                            particle.size =
                                this.size + this.sizeRandom * this.RANDM1TO1();
                            particle.size =
                                particle.size < 0 ? 0 : ~~particle.size;
                            particle.timeToLive =
                                this.lifeSpan +
                                this.lifeSpanRandom * this.RANDM1TO1();

                            particle.sharpness =
                                this.sharpness +
                                this.sharpnessRandom * this.RANDM1TO1();
                            particle.sharpness =
                        ...
                        update: function() {
                            ...
                            while (this.particleIndex < this.particleCount) {
                                var currentParticle = this.particles[
                                    this.particleIndex
                                ];
         ...
         */
                        play: function(id, repeat, volume) {
                            ...
                            c.volume = s.volume = s.obj.volume =
                                volume || Crafty.audio.volume;
            ...
            function(require, module, exports) {
                ...
                Crafty.c('SpriteAnimation', {
                    ...
                    _animationTick: function(frameData) {
                        ...
                        currentReel.easing.tick(
                            frameData.dt * this.animationSpeed
                        );
         ...
         */
                        pan: (function() {
                            ...
                            function enterFrame(e) {
                                ...
                                var v = easing.value();
                                Crafty.viewport.x =
                                    (1 - v) * startingX + v * targetX;
                                Crafty.viewport.y =
                                    (1 - v) * startingY + v * targetY;
                        ...
                        follow: (function() {
                            ...
                            return function(target, offsetx, offsety) {
                                ...
                                oldTarget = target;
                                offx =
                                    typeof offsetx != 'undefined' ? offsetx : 0;
                                offy =
                                    typeof offsety != 'undefined' ? offsety : 0;
                        ...
                        zoom: (function() {
                            ...
                            function enterFrame(e) {
                                ...
                                Crafty.viewport.scroll(
                                    '_x',
                                    startingX * (1 - v) + finalX * v
                                );
                                Crafty.viewport.scroll(
                                    '_y',
                                    startingY * (1 - v) + finalY * v
                                );
                                Crafty.viewport._clamp();
                            ...
                            return function(amt, cent_x, cent_y, time) {
                                ...
                                finalX = -(
                                    cent_x -
                                    Crafty.viewport.width / (2 * finalZoom)
                                );
                                finalY = -(
                                    cent_y -
                                    Crafty.viewport.height / (2 * finalZoom)
                                );
                        ...
                        init: function(w, h, stage_elem) {
                            ...
                            Crafty.stage.inner.style.transformStyle =
                                'preserve-3d'; // Seems necessary for Firefox to preserve zIndexes?
                            ...
                            if (Crafty.mobile) {
                                ...
                                if (
                                    typeof elem.webkitTapHighlightColor !==
                                    undefined
                                ) {
                                    elem.webkitTapHighlightColor =
                                        'rgba(0,0,0,0)';
                                }
