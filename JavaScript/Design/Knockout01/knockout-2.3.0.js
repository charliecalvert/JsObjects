        ...
        (function(q) {
            ...
            function G(b, c, d, f) {
                a.d[b] = {
                    ...
                    update: function(b, e, m, h, k) {
                        ...
                        var l = !m.fb;
                        if (l || c || h !== m.vb)
                            l && (m.fb = a.a.Oa(a.e.childNodes(b), !0)),
                                h
                                    ? (l || a.e.P(b, a.a.Oa(m.fb)),
                                      a.Ja(f ? f(k, e) : k, b))
                                    : a.e.ba(b),
                                (m.vb = h);
                    }
            ...
            a.a = (function() {
                ...
                var d = {},
                    f = {};
                d[
                    H && /Firefox\/2/i.test(H.userAgent)
                        ? 'KeyboardEvent'
                        : 'UIEvents'
                ...
                return {
                    ...
                    Mb: function(b) {
                        b = a.a.N(b);
                        for (
                            var e = s.createElement('div'), c = 0, d = b.length;
                            c < d;
                            c++
                        )
                    ...
                    Ga: function(a, b) {
                        ...
                        if ('undefined' != typeof t) {
                            ...
                            if ('function' == typeof a.dispatchEvent)
                                (e = s.createEvent(f[b] || 'HTMLEvents')),
                                    e.initEvent(
                                        b,
                                        !0,
                                        !0,
                    ...
                    Ob: function(e, c, d) {
                        ...
                        if ('object' == typeof e && 'form' === a.a.u(e))
                            for (
                                var p = e.action, r = f.length - 1;
                                0 <= r;
                                r--
                            )
                                for (
                                    var z = a.a.Ua(e, f[r]), D = z.length - 1;
                                    0 <= D;
                                    D--
                                )
            ...
            a.a.C = new (function() {
                ...
                return {
                    ...
                    cb: function(e, c) {
                        var g = b(e, !1);
                        g &&
                            (a.a.ka(g, c), 0 == g.length && a.a.f.set(e, d, q));
                    },
                    H: function(b) {
                ...
                function b(c, f) {
                    if (c)
                        if (8 == c.nodeType) {
                            ...
                            for (
                                var g = 0, e = c.childNodes, m = e.length;
                                g < m;
                                g++
                            )
                                b(e[g], f);
            ...
            a.Sa = {
                ...
                notify: function(b, c) {
                    b.equalityComparer =
                        'always' == c ? F(!1) : a.m.fn.equalityComparer;
                    return b;
                }
            };
            a.b('extenders', a.Sa);
            ...
            a.m = function(b) {
                function c() {
                    if (0 < arguments.length)
                        return (
                            (c.equalityComparer &&
                                c.equalityComparer(d, arguments[0])) ||
                                (c.K(), (d = arguments[0]), c.J()),
                            this
                        );
                    a.q.bb(c);
                    return d;
            ...
            a.Xa = function(b) {
                return ('function' == typeof b && b[A] === a.m) ||
                    ('function' == typeof b && b[A] === a.j && b.Eb)
                    ? !0
                    : !1;
            };
            a.b('observable', a.m);
            ...
            (function() {
                ...
                d.prototype = {
                    save: function(b, c) {
                        ...
                        0 <= e
                            ? (this.Ha[e] = c)
                            : (this.keys.push(b), this.Ha.push(c));
                    },
                    get: function(b) {
                        b = a.a.k(this.keys, b);
            ...
            (function() {
                function b(a) {
                    return (
                        8 == a.nodeType && (g ? a.text : a.nodeValue).match(e)
                    );
                }
                function c(a) {
                    return (
                        8 == a.nodeType && (g ? a.text : a.nodeValue).match(m)
                    );
                }
                function d(a, e) {
                ...
                var g =
                        s &&
                        '\x3c!--test--\x3e' === s.createComment('test').text,
                    e = g
                ...
                a.e = {
                    ...
                    P: function(c, e) {
                        if (b(c)) {
                            a.e.ba(c);
                            for (
                                var d = c.nextSibling, g = 0, f = e.length;
                                g < f;
                                g++
                            )
                    ...
                    Va: function(c, e, d) {
                        d
                            ? b(c)
                                ? c.parentNode.insertBefore(e, d.nextSibling)
                                : d.nextSibling
                                ? c.insertBefore(e, d.nextSibling)
                                : c.appendChild(e)
                            : a.e.ab(c, e);
                    },
                ...
                function d(b, c, d, h) {
                    ...
                    a.j(
                        function() {
                            ...
                            if (
                                (p =
                                    ('function' == typeof c ? c(f, b) : c) ||
                                    a.M.instance.getBindings(b, f))
                            )
                                0 === n &&
                                    ((n = 1),
                                    a.a.w(p, function(c) {
            ...
            a.d.attr = {
                update: function(b, c) {
                    ...
                    a.a.w(d, function(c, d) {
                        ...
                        8 >= a.a.ca && c in K
                            ? ((c = K[c]),
                              e ? b.removeAttribute(c) : (b[c] = d))
                            : e || b.setAttribute(c, d.toString());
            ...
            a.d.checked = {
                init: function(b, c, d) {
                    a.a.o(b, 'click', function() {
                        ...
                        var g = c(),
                            e = a.a.c(g);
                        'checkbox' == b.type && e instanceof Array
                            ? a.a.ja(g, b.value, b.checked)
                            : a.g.ha(g, d, 'checked', f, !0);
                    });
                    'radio' != b.type ||
                        b.name ||
                        a.d.uniqueName.init(b, F(!0));
                },
                update: function(b, c) {
                    var d = a.a.c(c());
                    'checkbox' == b.type
                        ? (b.checked =
                              d instanceof Array ? 0 <= a.a.k(d, b.value) : d)
                        : 'radio' == b.type && (b.checked = b.value == d);
                }
            };
            a.d.css = {
                update: function(b, c) {
                ...
                update: function(b, c, d) {
                    ...
                    if (c) {
                        ...
                        var r = a.a.Y(c, function(b) {
                            return (
                                k || b === q || null === b || !a.a.c(b._destroy)
                            );
                        });
                        'optionsCaption' in h &&
                            ((n = a.a.c(h.optionsCaption)),
                            null !== n && n !== q && r.unshift(l));
                    } else c = [];
                    d = g;
                    h.optionsAfterRender &&
                        (d = function(b, c) {
                            g(0, c);
                            a.q.I(h.optionsAfterRender, null, [
                                c[0],
                                b !== l ? b : q
                            ]);
                        });
                    a.a.Aa(
                        ...
                        function(b, c, d) {
                            ...
                            b === l
                                ? (a.a.fa(c, n), a.h.W(c, q))
                                : ((d = f(b, h.optionsValue, b)),
                                  a.h.W(c, a.a.c(d)),
                                  (b = f(b, h.optionsText, d)),
                                  a.a.ib(c, b));
                            return [c];
                        },
                        null,
            ...
            (function() {
                ...
                a.l.i.prototype.nodes = function() {
                    if (0 == arguments.length)
                        return (a.a.f.get(this.i, '__ko_anon_template__') || {})
                            .ma;
                    a.a.f.set(this.i, '__ko_anon_template__', {
                        ma: arguments[0]
                    });
            ...
            (function() {
                ...
                function f(b, f, h, k, l) {
                    ...
                    n &&
                        (c(h, k),
                        l.afterRender &&
                            a.q.I(l.afterRender, null, [h, k.$data]));
                    return h;
                }
                var g;
                a.Ba = function(b) {
                ...
                a.d.template = {
                    init: function(b, c) {
                        var d = a.a.c(c());
                        'string' == typeof d ||
                            d.name || (1 != b.nodeType && 8 != b.nodeType) ||
                            ((d =
                                1 == b.nodeType
                                    ? b.childNodes
                                    : a.e.childNodes(b)),
                    ...
                    update: function(b, c, d, f, g) {
                        ...
                        'string' != typeof c &&
                            ((d = c),
                            (c = a.a.c(d.name)),
                            'if' in d && (f = a.a.c(d['if'])),
                            f && 'ifnot' in d && (f = !a.a.c(d.ifnot)),
                            (n = a.a.c(d.data)));
                        'foreach' in d
                            ? (p = a.Rb(
                                  c || b,
                ...
                a.g.S.template = function(b) {
                    b = a.g.da(b);
                    return (1 == b.length && b[0].unknown) || a.g.Jb(b, 'name')
                        ? null
            ...
            a.a.Pa = (function() {
                ...
                return function(c, d, f) {
                    ...
                    return c.length <= d.length
                        ? a(c, d, 'added', 'deleted', f)
                        : a(d, c, 'deleted', 'added', f);
                };
            })();
                ...
                function c(c, f, g, e, m) {
                    ...
                    c = a.j(
                        function() {
                            var c = f(g, m, b(h)) || [];
                            0 < h.length &&
                                (a.a.eb(h, c), e && a.q.I(e, null, [g, c, m]));
                            h.splice(0, h.length);
                            a.a.R(h, c);
                        },
                        null,
                        ...
                        switch (((A = y.moved), y.status)) {
                            case 'deleted':
                                A === q &&
                                    ((u = n[s]),
                                    u.j && u.j.B(),
                                    v.push.apply(v, b(u.O)),
                                    e.beforeRemove && ((f[B] = u), w.push(u)));
                                s++;
                                break;
                            case 'retained':
                                h(B, s++);
                ...
                a.ua = function() {
                    var a = (this.Ib = (function() {
                        ...
                        try {
                            if (
                                0 <=
                                t.tmpl.tag.tmpl.open.toString().indexOf('__')
                            )
                                return 2;
                        } catch (a) {}
                        return 1;
                    ...
                    0 < a &&
                        ((t.tmpl.tag.ko_code = { open: "__.push($1 || '');" }),
                        (t.tmpl.tag.ko_with = {
                            open: 'with($1) {',
                            close: '} '
                        }));
