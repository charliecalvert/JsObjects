...
(function(global) {
        ...
        getBinding = function(attribute) {
            ...
            if (node.tagName === 'SELECT') {
                return node.multiple
                    ? new MultipleSelectBinding(attribute, node)
                    : new SelectBinding(attribute, node);
            }
        ...
        RadioNameBinding.prototype = {
            update: function() {
                ...
                if (node.checked) {
                    ...
                    this.root.set(
                        this.keypath,
                        node._ractive ? node._ractive.value : node.value
                    );
                    this.attr.receiving = false;
                }
            },
    ...
    (function() {
        ...
        initSelect = function() {
            ...
            this.deferredUpdate = this.parentNode.multiple
                ? updateMultipleSelect
                : updateSelect;
            this.deferredUpdate();
        };
        ...
        updateMultipleSelect = function() {
            ...
            while (i--) {
                options[i].selected =
                    value.indexOf(options[i]._ractive.value) !== -1;
            }
            ...
            if (hasOwn.call(proxies, eventName)) {
                ...
                while (i--) {
                    addEventProxy(
                        ...
                        eventNames[i],
                        proxies[eventName],
                        element.parentFragment.contextStack
                    );
                }
            }
        }
    ...
    (function() {
        ...
        addEventProxy = function(
            ...
            master =
                ...
                (events[triggerEventName] = new MasterEventHandler(
                    element,
                    triggerEventName,
                    contextStack,
                    indexRefs
        ...
        MasterEventHandler = function(element, eventName, contextStack) {
            ...
            if (
                (definition =
                    this.root.eventDefinitions[eventName] ||
                    Ractive.eventDefinitions[eventName])
            ) {
                this.custom = definition(
                    this.node,
                    getCustomHandler(eventName)
                );
            } else {
        ...
        MasterEventHandler.prototype = {
            add: function(proxy) {
                this.proxies[this.proxies.length] = new ProxyEvent(
                    this.element,
                    this.root,
                    proxy,
                    this.contextStack
    ...
    appendElementChildren = function(element, node, descriptor, docFrag) {
        if (
            typeof descriptor.f === 'string' &&
            (!node ||
                !node.namespaceURI || node.namespaceURI === namespaces.html)
        ) {
    ...
    bindElement = function(element, attributes) {
        ...
        switch (element.descriptor.e) {
            ...
            case 'input':
                if (
                    element.node.type === 'radio' ||
                    element.node.type === 'checkbox'
                ) {
    ...
    getElementNamespace = function(descriptor, parentNode) {
        ...
        return descriptor.e.toLowerCase() === 'svg'
            ? namespaces.svg
    ...
    executeTransition = function(
        ...
        transition =
            root.transitions[transitionName] ||
    ...
    (function() {
        ...
        reassignFragment = function(
            ...
            while (i--) {
                ...
                if (context.substr(0, oldKeypath.length) === oldKeypath) {
                    fragment.contextStack[i] = context.replace(
                        oldKeypath,
                        newKeypath
                    );
                }
        ...
        reassignElement = function(
            ...
            if (element.node._ractive) {
                if (
                    element.node._ractive.keypath.substr(
                        0,
                        oldKeypath.length
                    ) === oldKeypath
                ) {
                    element.node._ractive.keypath = element.node._ractive.keypath.replace(
                        oldKeypath,
                        newKeypath
                    );
                }
        ...
        reassignMustache = function(
            ...
            if (mustache.keypath) {
                if (
                    mustache.keypath.substr(0, oldKeypath.length) === oldKeypath
                ) {
                    unregisterDependant(mustache);

                    mustache.keypath = mustache.keypath.replace(
                        oldKeypath,
                        newKeypath
                    );
        ...
        Evaluator = function(root, keypath, functionStr, args, priority) {
            ...
            while (i--) {
                ...
                if (arg[0]) {
                    ...
                    this.refs[this.refs.length] = new Reference(
                        root,
                        arg[1],
                        this,
                        i,
        ...
        ExpressionResolver = function(mustache) {
            ...
            for (i = 0; i < len; i += 1) {
                ...
                if (indexRefs && indexRefs[ref] !== undefined) {
                    ...
                    this.scouts[this.scouts.length] = new ReferenceScout(
                        this,
                        ref,
                        mustache.contextStack,
                        i
                    );
                }
            }
        ...
        ExpressionResolver.prototype = {
            ...
            createEvaluator: function() {
                ...
                if (!this.root._evaluators[this.keypath]) {
                    this.root._evaluators[this.keypath] = new Evaluator(
                        this.root,
                        this.keypath,
                        this.str,
                        this.args,
                        this.mustache.priority
                    );
        ...
        getPartialDescriptor = function(root, name) {
            ...
            if (!partial) {
                if (root.debug && console && console.warn) {
                    console.warn(
                        'Could not find descriptor for partial "' + name + '"'
                    );
                }
        ...
        getPartialFromRegistry = function(registry, name) {
            if (registry.partials[name]) {
                ...
                if (typeof registry.partials[name] === 'string') {
                    ...
                    registry.partials[name] = Ractive.parse(
                        registry.partials[name]
                    );
                }
    ...
    initMustache = function(mustache, options) {
        ...
        if (options.descriptor.r) {
            if (
                parentFragment.indexRefs &&
                parentFragment.indexRefs[options.descriptor.r] !== undefined
            ) {
                ...
                if (keypath) {
                    ...
                    mustache.root._pendingResolution[
                        mustache.root._pendingResolution.length
                    ] = mustache;
    ...
    (function() {
        ...
        updateListSection = function(section, value, fragmentOptions) {
            ...
            if (length < section.length) {
                fragmentsToRemove = section.fragments.splice(
                    length,
            ...
            // otherwise...
                ...
                if (length > section.length) {
                    ...
                    for (i = section.length; i < length; i += 1) {
                        ...
                        fragmentOptions.contextStack = section.contextStack.concat(
                            section.keypath + '.' + i
                        );
                        ...
                        section.fragments[i] = section.createFragment(
                            fragmentOptions
                        );
                    }
                }
        ...
        updateListObjectSection = function(section, value, fragmentOptions) {
            ...
            fragmentsById =
                section.fragmentsById ||
                (section.fragmentsById = createFromNull());
        ...
        updateConditionalSection = function(
            section,
            value,
            inverted,
            fragmentOptions
            ...
            if (doRender) {
                if (!section.length) {
                    ...
                    section.fragments[0] = section.createFragment(
                        fragmentOptions
                    );
                    section.length = 1;
                }
    ...
    (function() {
        ...
        getItem = function(parser, preserveWhitespace) {
            ...
            return (
                getText(parser, preserveWhitespace) ||
        ...
        getMustache = function(parser, preserveWhitespace) {
            ...
            if (next.type === MUSTACHE || next.type === TRIPLE) {
                if (
                    next.mustacheType === SECTION ||
                    next.mustacheType === INVERTED
                ) {
        ...
        getElement = function(parser, preserveWhitespace) {
            ...
            if (next.type === TAG) {
                ...
                // sanitize
                if (
                    parser.options.sanitize &&
                    parser.options.sanitize.elements
                ) {
                    if (
                        parser.options.sanitize.elements.indexOf(stub.lcTag) !==
                        -1
                    ) {
                        return null;
                    }
    ...
    var allowWhitespace = function(tokenizer) {
        var match = leadingWhitespace.exec(
            tokenizer.str.substring(tokenizer.pos)
        );
    ...
    var fail = function(tokenizer, expected) {
        ...
        throw new Error(
            'Tokenizer failed: unexpected string "' +
                remaining +
                '" (expected ' +
                expected +
                ')'
    ...
    stripCommentTokens = function(tokens) {
        ...
        for (i = 0; i < tokens.length; i += 1) {
            ...
            if (
                current.mustacheType === COMMENT ||
                current.mustacheType === DELIMCHANGE
            ) {
    ...
    stripStandalones = function(tokens) {
        ...
        for (i = 2; i < tokens.length; i += 1) {
            ...
            if (
                current.type === TEXT &&
                backOne.type === MUSTACHE &&
                backTwo.type === TEXT
            ) {
                // ... and the mustache is a standalone (i.e. line breaks either side)...
                if (
                    trailingLinebreak.test(backTwo.value) &&
                    leadingLinebreak.test(current.value)
                ) {
                    // ... then we want to remove the whitespace after the first line break
                    // if the mustache wasn't a triple or interpolator or partial
                    if (
                        backOne.mustacheType !== INTERPOLATOR &&
                        backOne.mustacheType !== TRIPLE
                    ) {
                        backTwo.value = backTwo.value.replace(
                            trailingLinebreak,
                            '\n'
                        );
                    }
            ...
            if (typeof keypath === 'object') {
                ...
                for (k in keypath) {
                    if (hasOwn.call(keypath, k)) {
                        animations[animations.length] = animate(
                            this,
                            k,
                            keypath[k],
                            options
    ...
    (function(proto) {
        ...
        proto.get = function(keypath) {
            ...
            if (
                ...
                hasOwn.call(parentValue, key)
            ) {
                if (!this._wrapped[normalised]) {
                    this._wrapped[normalised] = wrapProperty(
                        parentValue,
                        key,
                        this,
                        normalised
            ...
            if (this.modifyArrays) {
                ...
                if (
                    normalised.charAt(0) !== '(' &&
                    isArray(value) &&
                    (!value._ractive || !value._ractive.setting)
                ) {
        ...
        wrapProperty = function(obj, prop, ractive, keypath) {
            ...
            if (!descriptor || hasOwn.call(descriptor, 'value')) {
                ...
                if (
                    ...
                    throw new Error(
                        'Property with getter but no setter, or vice versa. I am confused.'
                    );
                }
    ...
    clearCache = function(ractive, keypath) {
        ...
        if (ractive.modifyArrays) {
            if (keypath.charAt(0) !== '(') {
                // expressions (and their children) don't get wrapped
    ...
    notifyDependantsByPriority = function(
        ractive,
        keypath,
        priority,
        onlyDirect
    ...
    registerDependant = function(dependant) {
        ...
        depsByKeypath =
            ractive._deps[priority] || (ractive._deps[priority] = {});
        ...
        while (keys.length) {
            ...
            map =
                ractive._depsMap[parentKeypath] ||
                (ractive._depsMap[parentKeypath] = []);
    ...
    render = function(ractive, options) {
        ...
        ractive._transitionManager = transitionManager = makeTransitionManager(
            ractive,
            options.complete
        );
    ...
    resolveRef = function(ractive, ref, contextStack) {
        ...
        while (contextStack.length) {
            ...
            if (
                typeof parentValue === 'object' &&
                parentValue !== null &&
                hasOwn.call(parentValue, lastKey)
            ) {
        ...
        proto.observe = function(keypath, callback, options) {
            ...
            if (typeof keypath === 'object') {
                ...
                for (k in keypath) {
                    if (hasOwn.call(keypath, k)) {
                        callback = keypath[k];
                        observers[observers.length] = observe(
                            this,
                            k,
                            callback,
                            options
    ...
    (function(proto) {
        ...
        proto.set = function(keypath, value, complete) {
            ...
            this._transitionManager = transitionManager = makeTransitionManager(
                this,
                complete
            );
        ...
        attemptKeypathResolution = function(root) {
            ...
            while (i--) {
                // Work backwards, so we don't go in circles!
                ...
                if (
                    ...
                    root._pendingResolution[
                        root._pendingResolution.length
                    ] = unresolved;
                }
            }
        };
    ...
    adaptors.backboneCollection = function(collection, path) {
        ...
        return {
            init: function(view) {
                ...
                // initialise
                view.set(
                    path ? prefix(collection.toJSON()) : collection.toJSON()
                );
            },
    ...
    eventDefinitions.tap = function(node, fire) {
        ...
        mousedown = function(event) {
            ...
            move = function(event) {
                ...
                if (
                    Math.abs(event.clientX - x) >= distanceThreshold ||
                    Math.abs(event.clientY - y) >= distanceThreshold
                ) {
                    cancel();
                }
            };
        ...
        touchstart = function(event) {
            ...
            move = function(event) {
                ...
                if (
                    ...
                    event.touches[0].identifier !== finger
                ) {
                    cancel();
                }
                ...
                touch = event.touches[0];
                if (
                    Math.abs(touch.clientX - x) >= distanceThreshold ||
                    Math.abs(touch.clientY - y) >= distanceThreshold
                ) {
                    cancel();
                }
            };
    ...
    (function() {
        ...
        inheritFromChildProps = function(Child, childProps) {
            ...
            for (key in childProps) {
                if (
                    hasOwn.call(childProps, key) &&
                    !hasOwn.call(Child.prototype, key) &&
                    ...
                    if (
                        ...
                        typeof Child.prototype[key] === 'function'
                    ) {
                        Child.prototype[key] = wrapMethod(
                            member,
                            Child.prototype[key]
                        );
                    } else {
        ...
        conditionallyParseTemplate = function(Child) {
            ...
            if (typeof Child.template === 'string') {
                ...
                if (Child.template.charAt(0) === '#' && doc) {
                    templateEl = doc.getElementById(
                        Child.template.substring(1)
                    );
                    if (templateEl && templateEl.tagName === 'SCRIPT') {
                        Child.template = Ractive.parse(
            ...
            for (prop in from) {
                if (hasOwn.call(from, prop)) {
                    if (hasOwn.call(to, prop)) {
                        ...
                        interpolators[prop] = Ractive.interpolate(
                            from[prop],
                            to[prop]
                        );
                    } else {
    ...
    Ractive = function(options) {
        ...
        if (typeof template === 'string') {
            ...
            if (template.charAt(0) === '#' && doc) {
                ...
                if (templateEl) {
                    parsedTemplate = Ractive.parse(
                        templateEl.innerHTML,
                        options
                    );
                } else {
                    throw new Error(
                        'Could not find template element (' + template + ')'
                    );
                }
            } else {
        ...
        if (
            parsedTemplate &&
            parsedTemplate.length === 1 &&
            typeof parsedTemplate[0] === 'string'
        ) {
        ...
        this.transitionsEnabled = options.noIntro
            ? false
    ...
    (function() {
        ...
        if (cssTransitionsEnabled) {
            makeTransition = function(properties, defaults, outside, inside) {
                ...
                return function(node, complete, params, isIntro) {
                    ...
                    if (isIntro) {
                        ...
                        setTimeout(function() {
                            originalComputedStyles = getOriginalComputedStyles(
                                computedStyle,
                                properties
                            );
                    ...
                    startTransition = function() {
                        node.style[transition + 'Duration'] =
                            duration / 1000 + 's';
                        node.style[transition + 'Properties'] = properties
                            .map(hyphenate)
                            .join(',');
            ...
            transitions.fly = makeTransition(
                ['opacity', 'left', 'position'],
                {
                    duration: 400,
                    easing: 'easeOut'
                },
        ...
        typewriter = function(node, complete, params) {
            ...
            interval =
                ...
                (params.speed
                    ? 1000 / params.speed
                    : params.duration
                    ? node.textContent.length / params.duration
                    : 4);
    ...
    Animation.prototype = {
        tick: function() {
            ...
            if (this.running) {
                ...
                t = this.easing
                    ? this.easing(elapsed / this.duration)
    ...
    (function() {
        ...
        unregisterKeypathFromArray = function(array, keypath, root) {
            ...
            if (!array._ractive) {
                throw new Error(
                    'Attempted to remove keypath from non-wrapped array. This error is unexpected - please send a bug report to @rich_harris'
                );
            }
            ...
            if (!keypathsByGuid[root._guid]) {
                throw new Error(
                    'Ractive instance was not listed as a dependent of this array. This error is unexpected - please send a bug report to @rich_harris'
                );
            }
            ...
            if (keypathIndex === -1) {
                throw new Error(
                    'Attempted to unlink non-linked keypath from array. This error is unexpected - please send a bug report to @rich_harris'
                );
            }
        ...
        notifyArrayDependants = function(array, methodName, args) {
            ...
            processRoot = function(root) {
                ...
                root._transitionManager = transitionManager = makeTransitionManager(
                    root,
                    noop
                );
            ...
            processKeypath = function(root, keypath) {
                ...
                for (i = 0; i < root._deps.length; i += 1) {
                    // we can't cache root._deps.length as it may change!
            ...
            queueDependants = function(
                ...
                while (k--) {
                    ...
                    // is this a DOM section?
                        ...
                        dependant.keypath === keypath &&
                        dependant.type === SECTION /*&& dependant.parentNode*/
                    ) {
    ...
    (function() {
        ...
        DomAttribute = function(options) {
            ...
            if (this.name === 'value') {
                ...
                if (
                    this.parentNode.tagName === 'INPUT' &&
                    this.parentNode.type === 'file'
                ) {
        ...
        setStaticAttribute = function(attribute, options) {
            if (options.parentNode) {
                if (attribute.namespace) {
                    options.parentNode.setAttributeNS(
                        attribute.namespace,
                        options.name,
                        options.value
                    );
                } else {
                    options.parentNode.setAttribute(
                        options.name,
                        options.value
                    );
                }
        ...
        determinePropertyName = function(attribute, options) {
            ...
            if (
                ...
                !attribute.namespace &&
                (!options.parentNode.namespaceURI ||
                    options.parentNode.namespaceURI === namespaces.html)
            ) {
                ...
                if (
                    typeof options.parentNode[propertyName] === 'boolean' ||
                    propertyName === 'value'
                ) {
    ...
    (function() {
        ...
        DomComponent = function(options) {
            ...
            Component = getComponentConstructor(
                parentFragment.root,
                options.descriptor.e
            );
            ...
            processKeyValuePair = function(key, value) {
                ...
                if (
                    value.length === 1 &&
                    value[0].t === INTERPOLATOR &&
                    value[0].r
                ) {
                    // is it an index reference?
                    if (
                        parentFragment.indexRefs &&
                        parentFragment.indexRefs[value[0].r] !== undefined
                    ) {
                ...
                self.complexParameters[
                    self.complexParameters.length
                ] = parameter;
            ...
            if (options.descriptor.v) {
                for (eventName in options.descriptor.v) {
                    if (options.descriptor.v.hasOwnProperty(eventName)) {
                        propagateEvent(
                            eventName,
                            options.descriptor.v[eventName]
                        );
                    }
                }
            }
        ...
        teardown: function(detach) {
            ...
            if (this.descriptor.t2) {
                executeTransition(
                    ...
                    this.root,
                    this,
                    this.parentFragment.contextStack,
                    false
                );
            }
    ...
    DomPartial = function(options, docFrag) {
        ...
        descriptor = getPartialDescriptor(
            parentFragment.root,
            options.descriptor.r
        );
    ...
    DomSection.prototype = {
        ...
        smartUpdate: function(methodName, args) {
            ...
            if (this[methodName]) {
                // if not, it's sort or reverse, which doesn't affect us (i.e. our length)
        ...
        push: function(fragmentOptions, args) {
            ...
            for (i = start; i < end; i += 1) {
                fragmentOptions.contextStack = this.contextStack.concat(
                    this.keypath + '.' + i
                );
                fragmentOptions.index = i;
        ...
        splice: function(fragmentOptions, args) {
            ...
            removedItems =
                args[1] !== undefined ? args[1] : this.length - start;
            ...
            // Otherwise we need to add some things to the DOM
                ...
                insertionPoint = this.fragments[start]
                    ? this.fragments[start].firstNode()
                    : this.parentFragment.findNextNode(this);
    ...
    StringFragment.prototype = {
        ...
        getValue: function() {
            ...
            if (
                this.items.length === 1 &&
                this.items[0].type === INTERPOLATOR
            ) {
        ...
        transitionManager = {
            ...
            push: function(node) {
                transitionManager.active[
                    transitionManager.active.length
                ] = node;
            },
            pop: function(node) {
                transitionManager.active.splice(
                    transitionManager.active.indexOf(node),
                    1
                );
    ...
    splitKeypath = function(keypath) {
        ...
        while (remaining.length) {
            ...
            if (index === -1) {
                ...
                if (
                    remaining.charAt(index - 1) === '\\' &&
                    remaining.charAt(index - 2) !== '\\'
                ) {
            ...
            if (/\[/.test(part)) {
                keys = keys.concat(
                    part.replace(/\[\s*([0-9]+)\s*\]/g, '.$1').split('.')
                );
            } else {
    ...
    (function() {
        ...
        ElementStub = function(firstToken, parser, preserveWhitespace) {
            ...
            this.tag = svgCamelCaseElementsMap[this.lcTag]
                ? svgCamelCaseElementsMap[this.lcTag]
                : this.lcTag;
            ...
            if (firstToken.attrs) {
                ...
                if (
                    parser.options.sanitize &&
                    parser.options.sanitize.eventAttributes
                ) {
            ...
            while (next) {
                ...
                if (next.type === TAG) {
                    ...
                    // sibling element, which closes this element implicitly
                        ...
                        this.siblings &&
                        this.siblings.indexOf(next.name.toLowerCase()) !== -1
                    ) {
                        break;
                    }
                }
        ...
        ElementStub.prototype = {
            toJSON: function(noStringify) {
                ...
                if (this.attributes && this.attributes.length) {
                    ...
                    for (i = 0; i < len; i += 1) {
                        ...
                        if (json.a[name]) {
                            throw new Error(
                                'You cannot have multiple elements with the same name'
                            );
                        }
            ...
            toString: function() {
                ...
                isVoid =
                    voidElementNames.indexOf(this.tag.toLowerCase()) !== -1;
        ...
        filterAttrs = function(items) {
            ...
            for (i = 0; i < len; i += 1) {
                ...
                if (item.name === 'intro') {
                    if (filtered.intro) {
                        throw new Error(
                            'An element can only have one intro transition'
                        );
                    }
                    ...
                    if (filtered.outro) {
                        throw new Error(
                            'An element can only have one outro transition'
                        );
                    }
        ...
        jsonifyProxy = function(proxy) {
            ...
            if (proxy.dynamicArgs) {
                result.d = getFragmentStubFromTokens(
                    proxy.dynamicArgs
                ).toJSON();
            }
    ...
    (function() {
        ...
        stringify = function(token, refs) {
            ...
            switch (token.t) {
                ...
                case KEY_VALUE_PAIR:
                    return (
                        stringifyKey(token.k) + ':' + stringify(token.v, refs)
                    );

                case PREFIX_OPERATOR:
                    return (
                        (token.s === 'typeof' ? 'typeof ' : token.s) +
                        stringify(token.o, refs)
                    );

                case INFIX_OPERATOR:
                    return (
                        stringify(token.o[0], refs) +
                        (token.s.substr(0, 2) === 'in'
                            ? ' ' + token.s + ' '
                            : token.s) +
                        stringify(token.o[1], refs)
                    );

                case INVOCATION:
                    return (
                        stringify(token.x, refs) +
                        '(' +
                        (token.o ? token.o.map(map).join(',') : '') +
                        ')'
                    );
                ...
                default:
                    console.log(token);
                    throw new Error(
                        'Could not stringify expression token. This error is unexpected'
                    );
            }
        };
    ...
    FragmentStub.prototype = {
        toJSON: function(noStringify) {
            ...
            json = this['json_' + noStringify] = jsonifyStubs(
                this.items,
                noStringify
            );
            return json;
        ...
        while (next) {
            if (next.mustacheType === CLOSING) {
                if (next.ref.trim() === this.ref || this.expr) {
                    ...
                    throw new Error(
                        'Could not parse template: Illegal closing section'
                    );
                }
            }
    ...
    (function() {
        ...
        TextStub = function(token, preserveWhitespace) {
            this.type = TEXT;
            this.text = preserveWhitespace
                ? token.value
                : token.value.replace(whitespace, ' ');
        };
        ...
        TextStub.prototype = {
            toJSON: function() {
                ...
                return (
                    this.decoded ||
                    (this.decoded = decodeCharacterReferences(this.text))
                );
            },
    ...
    (function() {
        ...
        (function() {
            ...
            for (i = 0, len = prefixOperators.length; i < len; i += 1) {
                matcher = makePrefixSequenceMatcher(
                    prefixOperators[i],
                    fallthrough
                );
                fallthrough = matcher;
        ...
        makeInfixSequenceMatcher = function(symbol, fallthrough) {
            return function(tokenizer) {
                ...
                if (
                    symbol === 'in' &&
                    /[a-zA-Z_$0-9]/.test(tokenizer.remaining().charAt(0))
                ) {
                    tokenizer.pos = start;
                    return left;
                }
        ...
        (function() {
            ...
            for (i = 0, len = infixOperators.length; i < len; i += 1) {
                matcher = makeInfixSequenceMatcher(
                    infixOperators[i],
                    fallthrough
                );
                fallthrough = matcher;
        ...
        getReference = function(tokenizer) {
            ...
            while (
                (refinement =
                    getDotRefinement(tokenizer) ||
                    getArrayRefinement(tokenizer))
            ) {
                combo += refinement;
            }
    ...
    (function() {
        ...
        getMustacheOrTriple = function(tokenizer) {
            ...
            if (
                tokenizer.tripleDelimiters[0].length >
                tokenizer.delimiters[0].length
            ) {
    ...
    (function() {
        ...
        getAttributeValue = function(tokenizer) {
            ...
            value =
                getSingleQuotedAttributeValue(tokenizer) ||
                getDoubleQuotedAttributeValue(tokenizer) ||
        ...
        getUnquotedAttributeValue = function(tokenizer) {
            ...
            token =
                getMustacheOrTriple(tokenizer) ||
                getUnquotedAttributeValueToken(tokenizer);
            while (token !== null) {
        ...
        getSingleQuotedAttributeValue = function(tokenizer) {
            ...
            token =
                getMustacheOrTriple(tokenizer) ||
                getSingleQuotedStringToken(tokenizer);
            while (token !== null) {
                tokens[tokens.length] = token;
                token =
                    getMustacheOrTriple(tokenizer) ||
        ...
        getDoubleQuotedAttributeValue = function(tokenizer) {
            ...
            token =
                getMustacheOrTriple(tokenizer) ||
                getDoubleQuotedStringToken(tokenizer);
            while (token !== null) {
                tokens[tokens.length] = token;
                token =
                    getMustacheOrTriple(tokenizer) ||
    ...
    var getText = function(tokenizer) {
        ...
        [tokenizer.delimiters[0], tokenizer.tripleDelimiters[0], '<'].forEach(
            function(substr) {
        ...
        parse = function(template, options) {
            ...
            if (!options.preserveWhitespace) {
                ...
                if (
                    token &&
                    token.type === TEXT &&
                    onlyWhitespace.test(token.value)
                ) {
                    tokens.shift();
                }
            ...
            fragmentStub = getFragmentStubFromTokens(
                tokens,
                options,
        ...
        parseCompoundTemplate = function(template, options) {
            ...
            while ((startMatch = inlinePartialStart.exec(remaining))) {
                ...
                if (!endMatch || endMatch[1] !== name) {
                    throw new Error(
                        'Inline partials must have a closing delimiter, and cannot be nested'
                    );
                }

                partials[name] = parse(
                    remaining.substr(0, endMatch.index),
                    options
                );
