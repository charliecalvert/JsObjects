                ...
                <div className="row">
                    <div className="grid-example col s12">
                        <span className="flow-text">
                            I am always full-width (col s12) in every way and in
                            every place they say
                        </span>
                    </div>
                    <div className="grid-example col s12 m12 l12 xl6">
                        <span className="flow-text">
                            I am full-width on mobile it seems to me asdf
                            asdfasdf asdfsadf addddddddd (col s12 m6)
                        </span>{' '}
                    </div>
                </div>
