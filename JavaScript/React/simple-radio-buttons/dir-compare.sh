...
if [ -n "$EXCLUDE_PATTERN" ]; then
    ...
    echo "====================="
    echo "No exclude pattern provided using elven default"
    echo "====================="
    diff -rq --exclude=".git" --exclude "node_modules" --exclude="*.save" --exclude="*.old" --exclude="*.sh" --exclude="README.md"  "$DIR1" "$DIR2"
fi
