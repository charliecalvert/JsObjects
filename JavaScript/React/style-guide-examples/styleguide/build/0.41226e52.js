        ...
        (r = function() {
            ...
            function isWordCharBasic(e) {
                return (
                    /\w/.test(e) ||
                    (e > '' &&
                        (e.toUpperCase() != e.toLowerCase() || E.test(e)))
                );
            }
                ...
                if (!c) {
                    ...
                    if (y > 0 && s)
                        for (var b = 0; b < s.length; ++b)
                            null == s[b].to &&
                                (v || (v = [])).push(
                                    new MarkedSpan(s[b].marker, null, null)
                                );
                    ...
                    for (var s = 0; s < a.length; ++s) {
                        ...
                        if (l.marker.collapsed) {
                            var c = l.marker.find(0),
                                u =
                                    cmp(c.from, n) ||
                                    extraLeft(l.marker) - extraLeft(o),
                                d =
                                    cmp(c.to, r) ||
                                    extraRight(l.marker) - extraRight(o);
                            if (
                                !((u >= 0 && d <= 0) || (u <= 0 && d >= 0)) &&
                                ((u <= 0 &&
                    ...
                    for (var I, F = [], B = 0; B < d; )
                        if (i.test(p[B])) {
                            ...
                            for (var V = R; V < B; )
                                if (a.test(p[V])) {
                                    R < V &&
                                        F.splice(j, 0, new BidiSpan(1, R, V));
                                    var _ = V;
                                    for (++V; V < B && a.test(p[V]); ++V);
                                    F.splice(j, 0, new BidiSpan(2, _, V)),
                                        (R = V);
                                } else ++V;
            ...
            var G,
                ...
                q =
                    'oncopy' in (G = elt('div')) ||
                    (G.setAttribute('oncopy', 'return;'),
                    'function' == typeof G.oncopy),
                X = null;
            ...
            function findStartLine(e, t, n) {
                for (
                    ...
                    if (
                        c &&
                        (!n ||
                            s + (c instanceof ee ? c.lookAhead : 0) <=
                                i.modeFrontier)
                    )
                        return s;
                    ...
                    (r.pos = 0),
                        ...
                        insertLineContent(
                            ...
                            getLineStyles(
                                e,
                                i,
                                t != e.display.externalMeasured && lineNo(i)
                            )
                        ),
                        i.styleClasses &&
                        ...
                        0 == o
                            ...
                            : ((t.measure.maps || (t.measure.maps = [])).push(
                              ...
                              (
                                  t.measure.caches || (t.measure.caches = [])
                              ).push({}));
                }
                if (l) {
                ...
                return (
                    t.cache.hasOwnProperty(a)
                        ...
                        : (t.rect ||
                          ...
                          t.hasHeights ||
                              (ensureLineHeights(e, t.view, t.rect),
                              (t.hasHeights = !0)),
                          (i = measureCharInner(e, t, n, r)).bogus ||
                              (t.cache[a] = i)),
                    {
                        left: i.left,
                        right: i.right,
                ...
                if (3 == l.nodeType) {
                    for (var p = 0; p < 4; p++) {
                        for (
                            ...
                            c &&
                            isExtendingChar(
                                t.line.text.charAt(i.coverStart + c)
                            );
                        ...
                        for (
                            ...
                            isExtendingChar(
                                t.line.text.charAt(i.coverStart + u)
                            );
                    ...
                    c || (m != l && m != s) || m++,
                        (h =
                            0 == m
                                ...
                                : m == t.text.length
                                    ? 'before'
                                    : measureCharPrepared(e, i, m - (c ? 1 : 0))
                                          .bottom +
                                          a <=
                                          o ==
                                      c
            ...
            function estimateHeight(e) {
                ...
                return function(o) {
                    ...
                    return n
                        ? i + (Math.ceil(o.text.length / r) || 1) * t
                        : i + t;
                };
            }
            ...
            function posFromMouse(e, t, n, r) {
                ...
                if (
                    ...
                    var u =
                        countColumn(l, l.length, e.options.tabSize) - l.length;
                    c = Pos(
                        c.line,
                        Math.max(
                            0,
                            Math.round(
                                (i - paddingH(e.display).left) /
                                    charWidth(e.display)
                            ) - u
                        )
                    );
            ...
            function adjustView(e, t, n) {
                ...
                0 == r.view.length || t >= r.viewTo || n <= r.viewFrom
                    ...
                    : (r.viewFrom > t
                          ? (r.view = buildViewArray(e, t, r.viewFrom).concat(
                                r.view
                            ))
                          : r.viewFrom < t &&
            ...
            function updateGutters(e) {
                ...
                for (var r = 0; r < n.length; ++r) {
                    var o = n[r],
                        i = t.appendChild(
                            elt('div', null, 'CodeMirror-gutter ' + o)
                        );
                    ...
                    if (o && !n && !d && null != me)
                        return (
                            i &&
                                ...
                                updateScrollTop(
                                    e,
                                    Math.max(0, s.scrollTop + i * me)
                                ),
                            setScrollLeft(
                                e,
                                Math.max(0, s.scrollLeft + o * me)
                            ),
            ...
            function computeSelAfterChange(e, t) {
                for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
                    ...
                    n.push(
                        new ye(
                            adjustForChange(o.anchor, t),
                            adjustForChange(o.head, t)
                        )
                    );
                }
            ...
            function updateDoc(e, t, n, r) {
                ...
                if (t.full)
                    ...
                    if (1 == a.length)
                        update(
                            s,
                            s.text.slice(0, o.ch) + c + s.text.slice(i.ch),
                            u
                        );
                    else {
            ...
            function addChangeToHistory(e, t, n, r) {
                ...
                if (
                    ...
                    for (
                        (l && l.ranges) ||
                            pushSelectionToHistory(e.sel, o.done),
                            i = {
            ...
            function extendSelections(e, t, n) {
                for (
                    var r = [],
                        o = e.cm && (e.cm.display.shift || e.extend),
                        i = 0;
            ...
            function rebaseHist(e, t) {
                ...
                rebaseHistArray(e.done, n, r, o),
                    rebaseHistArray(e.undone, n, r, o);
            }
            function changeLine(e, t, n, r) {
                ...
                return (
                    ...
                    null == o
                        ? null
                        : (r(i, o) && e.cm && regLineChange(e.cm, o, n), i)
                );
            }
                ...
                return (
                    linkedDocs(e, function(e) {
                        s && (r.widgetNode = s.cloneNode(!0)),
                            i.push(
                                markText(e, clipPos(e, t), clipPos(e, n), r, o)
                            );
            ...
            function deleteNearSelection(e, t) {
                for (
                    var n = e.doc.sel.ranges, r = [], o = 0;
                    o < n.length;
                    o++
                ) {
                    for (
                        var i = t(n[o]);
                        r.length && cmp(i.from, lst(r).to) <= 0;
                    ...
                    if (i) {
                        ...
                        if (s.level > 0 || 'rtl' == t.doc.direction) {
                            ...
                            (a = findFirst(
                                function(e) {
                                    return (
                                        measureCharPrepared(t, c, e).top == u
                                    );
                                },
            ...
            function onKeyPress(e) {
                ...
                if (
                    ...
                    var n = e.keyCode,
                        r = e.charCode;
                    if (d && n == Ee)
                        return (Ee = null), void e_preventDefault(e);
                    if (
                        !d ||
                        (e.which && !(e.which < 10)) ||
            ...
            function gutterEvent(e, t, n, r) {
                ...
                if (
                    o >=
                    Math.floor(e.display.gutters.getBoundingClientRect().right)
                )
                    return !1;
                r && e_preventDefault(t);
                var a = e.display,
                    s = a.lineDiv.getBoundingClientRect();
                if (i > s.bottom || !hasHandler(e, n))
            ...
            function indentLine(e, t, n, r) {
                ...
                'prev' == n
                    ? (c =
                          t > i.first
                              ? countColumn(getLine(i, t - 1).text, null, a)
                              : 0)
                    : 'add' == n
                        ...
                        if (
                            ...
                            if (i.electricChars) {
                                for (var s = 0; s < i.electricChars.length; s++)
                                    if (
                                        t.indexOf(i.electricChars.charAt(s)) >
                                        -1
                                    ) {
                                ...
                                i.electricInput &&
                                    i.electricInput.test(
                                        getLine(e.doc, o.head.line).text.slice(
                                            0,
                                            o.head.ch
                                        )
                                    ) &&
                                    (a = indentLine(e, o.head.line, 'smart'));
                            a &&
                                signalLater(e, 'electricInput', e, o.head.line);
                        }
                    }
            }
                    ...
                    (e.prototype = {
                        ...
                        heightAtLine: function(e, t, n) {
                            ...
                            return (
                                ...
                                (o ? this.doc.height - heightAtLine(r) : 0)
                            );
                        },
                        ...
                        addWidget: function(e, t, n, r, o) {
                            ...
                            (t.style.top = c + 'px'),
                                ...
                                'right' == o
                                    ? ((u =
                                          l.sizer.clientWidth - t.offsetWidth),
                                      (t.style.right = '0px'))
                                    : ('left' == o
                                          ? (u = 0)
                                          : 'middle' == o &&
                                ...
                                n &&
                                    ...
                                    null !=
                                        (s = calculateScrollPos(i, a))
                                            .scrollTop &&
                                        updateScrollTop(i, s.scrollTop),
                                    null != s.scrollLeft &&
                                        setScrollLeft(i, s.scrollLeft));
                        },
                        ...
                        findPosH: function(e, t, n, r) {
                            ...
                            for (
                                ...
                                a < t &&
                                !(i = findPosH(this.doc, i, o, n, r)).hitSide;
                                ++a
                            );
                            return i;
                        },
            ...
            e.defineMode('javascript', function(t, n) {
                ...
                function parseJS(e, t, n, r, o) {
                    ...
                    for (
                        ...
                        if (
                            (i.length ? i.pop() : l ? expression : statement)(
                                n,
                                r
                            )
                        ) {
                ...
                function targetNoComma(e, t) {
                    if ('target' == t)
                        return (
                            (m.marked = 'keyword'), cont(maybeoperatorNoComma)
                        );
                }
                    ...
                    (poplex.lex = !0),
                    {
                        startState: function(e) {
                            var t = {
                                ...
                                context:
                                    n.localVars && new Context(null, null, !1),
                                indented: e || 0
                            };
                            return (
                                n.globalVars &&
                        ...
                        indent: function(t, n, r) {
                            ...
                            if (t.tagName)
                                return !1 !== l.multilineTagIndentPastTag
                                    ...
                                    : t.tagStart +
                                          s * (l.multilineTagIndentFactor || 1);
                                ...
                                .forEach(function(e) {
                                    switch (e) {
                                        case 'onBlur':
                                            ...
                                            break;
                                        case 'onContextMenu':
                                            t.editor.on('contextmenu', function(
                                                e,
                                                n
                                            ) {
                                                t.props.onContextMenu(
                                                    t.editor,
                                                    n
                                                );
                                            });
                                        ...
                                        case 'onDblClick':
                                            ...
                                            break;
                                        case 'onDragEnter':
                                            t.editor.on('dragenter', function(
                                                e,
                                                n
                                            ) {
                                                t.props.onDragEnter(
                                            ...
                                            break;
                                        case 'onDragLeave':
                                            t.editor.on('dragleave', function(
                                                e,
                                                n
                                            ) {
                                                t.props.onDragLeave(
                                        ...
                                        case 'onDragOver':
                                            ...
                                            break;
                                        case 'onDragStart':
                                            t.editor.on('dragstart', function(
                                                e,
                                                n
                                            ) {
                                                t.props.onDragStart(
                                        ...
                                        case 'onFocus':
                                            ...
                                            break;
                                        case 'onGutterClick':
                                            t.editor.on('gutterClick', function(
                                                e,
                                                n,
                                                r,
                                                o
                                        ...
                                        case 'onKeyUp':
                                            ...
                                            break;
                                        case 'onMouseDown':
                                            t.editor.on('mousedown', function(
                                                e,
                                                n
                                            ) {
                                                t.props.onMouseDown(
                                        ...
                                        case 'onPaste':
                                            ...
                                            break;
                                        case 'onRenderLine':
                                            t.editor.on('renderLine', function(
                                                e,
                                                n,
                                                r
                                            ) {
                                                t.props.onRenderLine(
                                                    t.editor,
                                                    n,
                                                    r
                                                );
                                        ...
                                        case 'onSelection':
                                            ...
                                            break;
                                        case 'onTouchStart':
                                            t.editor.on('touchstart', function(
                                                e,
                                                n
                                            ) {
                                                t.props.onTouchStart(
                                                    t.editor,
                                                    n
                                                );
                                            });
                    ...
                    return (
                        ...
                        (Controlled.prototype.initChange = function(e) {
                            ...
                            var t = this.editor.lastLine(),
                                n = this.editor.getLine(this.editor.lastLine())
                                    .length;
                        ...
                        (Controlled.prototype.componentDidMount = function() {
                            ...
                            c ||
                                ...
                                this.editor.getOption('autofocus') &&
                                    this.editor.focus(),
                    ...
                    (UnControlled.prototype.hydrate = function(e) {
                        ...
                        if (
                            ...
                            var r = this.editor.lastLine(),
                                i = this.editor.getLine(this.editor.lastLine())
                                    .length;
                            this.editor.replaceRange(
                                e.value || '',
                                { line: 0, ch: 0 },
            ...
            g = (function(e) {
                function Editor() {
                    ...
                    var e = _possibleConstructorReturn(
                        this,
                        (
                            Editor.__proto__ || Object.getPrototypeOf(Editor)
                        ).call(this)
                    );
