...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getEight", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "counterUp", function () {
      _this.store.dispatch({
        type: 'INCREMENT'
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "counterDown", function () {
      _this.store.dispatch({
        type: 'DECREMENT'
      });
    });

    _this.getNine = _this.getNine.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(App, [{
    ...
    value: function setupState() {
      ...
      this.store = Object(redux__WEBPACK_IMPORTED_MODULE_1__["createStore"])(counter);
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, this.state.title), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Welcome to ", this.state.title, ". This is a standard Express app with React and Redux circa March, 2017."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        onClick: this.getEight
      }, "Get Eight"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        onClick: this.getNine
      }, "Get Nine"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Eight: ", this.state.eight), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Nine: ", this.state.nine), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "The Countered"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        onClick: this.counterUp
      }, "Increment Counter"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        onClick: this.counterDown
      }, "Decrement Counter"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Counter: ", this.state.counter), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Debugging Tip"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "To get started debugging your webpack, add this to the", ' ', react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("strong", null, "webpack.config.js"), " config file:"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("pre", null, "devtool: 'source-map',"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Open the debugger and go webpack in the navigation pane."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
        src: "debug-web.png",
        alt: "debugging"
      }));
    }
...
/* harmony import */ var _AppWithEmbeddedJsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AppWithEmbeddedJsx */ "./source/AppWithEmbeddedJsx.js");
/**
 * Created by charlie on 3/31/17.
 */
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_AppWithEmbeddedJsx__WEBPACK_IMPORTED_MODULE_2__["default"], null)), document.getElementById('root'));
