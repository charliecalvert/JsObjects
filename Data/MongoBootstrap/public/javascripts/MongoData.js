...
angular
    ...
    .constant('CONFIG', {
        ...
        COLLECTION: 'address',
        API_KEY:
            'Log into MLAB. Click on your name. Get an API_KEY. Put it here.'
    })
    .controller('MyController', function($scope, $http, presidents) {
        ...
        $scope.presidents = presidents.query(
            {},
            function(presidents) {
            ...
            function(error) {
                ...
                alert(
                    'Check the console and your CONFIG.DBNAME & CONFIG.API_KEY'
                );
            }
        );
        ...
        $scope.deleteRow = function() {
            ...
            $scope.presidents[userIndexSelection].remove(
        ...
        $scope.updateRow = function() {
            ...
            $scope.presidents[indexOfItemToUpdate].phoneMobile =
                $scope.phoneMobile;
            ...
            $scope.presidents[indexOfItemToUpdate].updateMe(
                ...
                function(err) {
                    console.log(
                        'Error Status: ' + err.status + ' ' + err.data.message
                    );
                }
            );
        };
        ...
        $scope.indexChange = function() {
            $scope.firstName =
                $scope.presidents[$scope.userIndexSelection].firstName;
            $scope.lastName =
                $scope.presidents[$scope.userIndexSelection].lastName;
            $scope.address =
                $scope.presidents[$scope.userIndexSelection].address;
            ...
            $scope.phoneMobile =
                $scope.presidents[$scope.userIndexSelection].phoneMobile;
            $scope.phoneHome =
                $scope.presidents[$scope.userIndexSelection].phoneHome;
