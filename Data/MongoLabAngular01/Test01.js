...
describe('mycontrollertest', function() {
    ...
    it('Test hint', function() {
        expect(myController.hint).toEqual(
    ...
    it('can find tower hitpoints', function() {
        $httpBackend
            .expectGET(
                'https://api.mongolab.com/api/1/databases/elvenlab01/collections/Presidents?apiKey=qfSxFoUGHBA1EuUlqhux_op2fy6oF_wy'
            )
            .respond([
                {
        ...
        $httpBackend.flush();
        expect(myController.presidents[0].presidentName).toEqual(
            'George Washington'
        );
    });
});
