...
app.get('/couchReadAttached', function(request, response) {
    'use strict';
    console.log('/getAttachedHtml called');
    console.log(request.query);
    couch.couchCode.getAttachedDocument(
        response,
...
app.get('/couchReadHtml', function(request, response) {
    'use strict';
    console.log('/getAttachedHtml called');
    console.log(request.query);
...
app.get('/couchReadImage', function(request, response) {
    'use strict';
...
console.log(
    'CouchDb URL from Library/CouchCode: ' + couch.couchCode.getCouchUrl()
);
